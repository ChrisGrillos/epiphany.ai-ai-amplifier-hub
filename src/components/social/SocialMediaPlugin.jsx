...
import {
  Share2, Sparkles, Upload, X, Image, FileText, Loader2,
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
      ...
      <p className="text-sm text-zinc-400 mb-1 max-w-xs">
        Let Epi craft and prepare platform-optimized posts from your vault content, drafts, or raw ideas.
      </p>
      <div className="flex flex-col gap-2 mt-4 mb-6 text-left w-full max-w-xs">
        {[
          ...
          'Copy-ready drafts with hashtags',
        ].map((f, i) => (
      ...
      <p className="text-[10px] text-zinc-600 mt-3">
        Coming soon: direct scheduling via connected accounts
      </p>
    </div>
  );
}
...
export default function SocialMediaPlugin({ open, onOpenChange, vault, isSubscribed: isSubscribedProp }) {
  // For now, allow unlocking locally (real billing hook goes here)
      ...
      <SheetContent className="w-[620px] sm:max-w-[620px] bg-zinc-900 border-zinc-800 p-0 flex flex-col">
        <SheetHeader className="p-4 pb-3 border-b border-zinc-800 shrink-0">
          ...
          <p className="text-xs text-zinc-500 mt-0.5">
            Instruct Epi to craft platform-optimized posts from your content.
          </p>
        </SheetHeader>
